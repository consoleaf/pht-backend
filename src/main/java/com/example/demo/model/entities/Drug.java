...
public class Drug {
  ...
  @Column(columnDefinition = "TEXT") private String inp_name;
  @OneToMany(mappedBy = "drug", cascade = CascadeType.MERGE,
             orphanRemoval = true)
  private Set<TradeName> trade_names;
  @Column(columnDefinition = "TEXT") private String pharm_dynamics;
  ...
  @Column(columnDefinition = "TEXT") private String contraindications;
  @Column(columnDefinition = "TEXT") private String role_in_treatment;
  @OneToMany(mappedBy = "drug", cascade = CascadeType.ALL, orphanRemoval = true)
  private Set<Dosage> dosages;

  // Pregnancy info
  @Column(columnDefinition = "TEXT") private String fda_category;
  @Column(columnDefinition = "TEXT") private String pregnancy_usage;
  @Column(columnDefinition = "TEXT") private String pregnancy_additional_info;

  @OneToMany(mappedBy = "drug", orphanRemoval = true)
  private Set<Interaction> interactions;

  // Liver condition based dosage info
  @Column(columnDefinition = "TEXT") private String dose_change_prerequisites;
  @OneToMany(mappedBy = "drug", cascade = CascadeType.ALL, orphanRemoval = true)
  private Set<CreatinineBasedDosage> creatinine_based_dosages;

  // Food info
  @Column(columnDefinition = "TEXT") private String food_recommendations;
  @Column(columnDefinition = "TEXT") private String food_comment;
  ...
  public void setCreatinine_based_dosages(
      Set<CreatinineBasedDosage> creatinine_based_dosages) {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((creatinine_based_dosages == null)
                                   ? 0
                                   : creatinine_based_dosages.hashCode());
    result = prime * result + ((dosages == null) ? 0 : dosages.hashCode());
    result = prime * result + ((dose_change_prerequisites == null)
                                   ? 0
                                   : dose_change_prerequisites.hashCode());
    result =
        prime * result + ((fda_category == null) ? 0 : fda_category.hashCode());
    result =
        prime * result + ((first_line == null) ? 0 : first_line.hashCode());
    result =
        prime * result + ((food_comment == null) ? 0 : food_comment.hashCode());
    result =
        prime * result +
        ((food_recommendations == null) ? 0 : food_recommendations.hashCode());
    result = prime * result + ((id == null) ? 0 : id.hashCode());
    result = prime * result + ((inp_name == null) ? 0 : inp_name.hashCode());
    result =
        prime * result + ((interactions == null) ? 0 : interactions.hashCode());
    result = prime * result +
             ((pharm_dynamics == null) ? 0 : pharm_dynamics.hashCode());
    result = prime * result +
             ((pharm_kinetics == null) ? 0 : pharm_kinetics.hashCode());
    result = prime * result + ((pregnancy_additional_info == null)
                                   ? 0
                                   : pregnancy_additional_info.hashCode());
    result = prime * result +
             ((pregnancy_usage == null) ? 0 : pregnancy_usage.hashCode());
    result = prime * result +
             ((role_in_treatment == null) ? 0 : role_in_treatment.hashCode());
    result =
        prime * result + ((side_effects == null) ? 0 : side_effects.hashCode());
    result =
        prime * result + ((trade_names == null) ? 0 : trade_names.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (dose_change_prerequisites == null) {
      if (other.dose_change_prerequisites != null)
        return false;
    } else if (!dose_change_prerequisites.equals(
                   other.dose_change_prerequisites))
      return false;
    ...
    if (pregnancy_additional_info == null) {
      if (other.pregnancy_additional_info != null)
        return false;
    } else if (!pregnancy_additional_info.equals(
                   other.pregnancy_additional_info))
      return false;
    ...
    if (side_effects == null) {
      ...
      return false;
    if (trade_names == null) {
      if (other.trade_names != null)
        return false;
    } else if (!trade_names.equals(other.trade_names))
      return false;
    return true;
  }

  public String getInp_name() { return inp_name; }

  public void setInp_name(String inp_name) { this.inp_name = inp_name; }

  public Boolean getFirst_line() { return first_line; }

  public void setFirst_line(Boolean first_line) {
    this.first_line = first_line;
  }

  public String getFda_category() { return fda_category; }

  public void setFda_category(String fda_category) {
    this.fda_category = fda_category;
  }

  public String getFood_comment() { return food_comment; }

  public void setFood_comment(String food_comment) {
    this.food_comment = food_comment;
  }

  public String getPharm_dynamics() { return pharm_dynamics; }

  public void setPharm_dynamics(String pharm_dynamics) {
    this.pharm_dynamics = pharm_dynamics;
  }

  public String getPregnancy_usage() { return pregnancy_usage; }
  ...
  public String getRole_in_treatment() { return role_in_treatment; }

  public void setRole_in_treatment(String role_in_treatment) {
    this.role_in_treatment = role_in_treatment;
  }

  public String getFood_recommendations() { return food_recommendations; }
  ...
  public ActingSubstance getActing_substance() { return acting_substance; }
