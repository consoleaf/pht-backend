...
public class CreatinineBasedDosage {
  ...
  @Column(columnDefinition = "TEXT") private String creatinine_clearance;
  @Column(columnDefinition = "TEXT") private String dosage_fraction;
  ...
  public int hashCode() {
    ...
    result =
        prime * result +
        ((creatinine_clearance == null) ? 0 : creatinine_clearance.hashCode());
    result = prime * result +
             ((dosage_fraction == null) ? 0 : dosage_fraction.hashCode());
  ...
  public String getCreatinine_clearance() { return creatinine_clearance; }

  public void setCreatinine_clearance(String creatinine_clearance) {
    this.creatinine_clearance = creatinine_clearance;
  }

  public String getDosage_fraction() { return dosage_fraction; }
