DELETE IN public.acting_substances WHERE TRUE;
DELETE IN public.creatinine_dosages WHERE TRUE;
DELETE IN public.dosages WHERE TRUE;
DELETE IN public.interactions WHERE TRUE;
DELETE IN public.pharm_kinetic WHERE TRUE;
DELETE IN public.trade_names WHERE TRUE;
DELETE IN public.drugs WHERE TRUE;
